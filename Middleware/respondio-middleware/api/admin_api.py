...
async def debug_read_google_sources(
    ...
    """
    Directly exports and reads live text/CSV from Google Doc Governance, Reglas RNE, and Scripts SC
    using the Service Account Drive Export API.
    """
    incoming_secret = x_webhook_secret or secret
    ...
    # 1. Export Google Doc Governance (Reglas Generales / Proyecto Max)
    ...
    # 2. Export Reglas RNE Sheet as CSV
    ...
    # 3. Export Scripts SC Sheet as CSV
