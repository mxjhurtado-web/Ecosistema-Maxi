...
# Se puede sobreescribir via variables de entorno
SA_JSON_B64 = (settings.GOOGLE_SA_JSON_B64 or os.getenv("GOOGLE_SA_JSON_B64", os.getenv("MAXIBOT_SA_BASE64", ""))).strip()
