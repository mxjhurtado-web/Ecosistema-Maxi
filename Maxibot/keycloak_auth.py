...
"""
Módulo de autenticación con Keycloak para MaxiBotd
...
class KeycloakAuth:
            ...
            def do_GET(self):
                if self.path.startswith('/callback'):
                    ...
                    if 'code' in query_params:
                        ...
                        <head>
                            <meta charset="utf-8">
                            <title>MaxiBot - Autenticación Exitosa</title>
                            <style>
                                body {
                        ...
                        <body>
                            <div class="container">
                                ...
                                <p>Puedes cerrar esta ventana y volver a MaxiBot.</p>
                            </div>
    ...
    def verify_user_roles(self) -> bool:
        """Verifica si el usuario tiene roles válidos para MaxiBot"""
        ...
        try:
            ...
            # Verificar si tiene roles de MaxiBot
    ...
    def authenticate(self) -> Tuple[bool, str]:
        ...
        try:
            ...
            if not self.verify_user_roles():
                ...
                return False, "Usuario no tiene permisos para acceder a MaxiBot"
    ...
    def logout(self) -> bool:
        """
        Cierra sesión en Keycloak y limpia tokens locales
        Permite salir de la sesión en cualquier momento
        """
        try:
            if self.access_token and self.refresh_token:
                ...
                try:
                    response = requests.post(
                        kc_config.LOGOUT_ENDPOINT, data=data, timeout=10)
                    print(f"Logout Keycloak: {response.status_code}")
                except Exception as e:
                    print(f"Error en logout de Keycloak: {e}")
